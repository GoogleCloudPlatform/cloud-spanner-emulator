...
DataChangeRecord ChangeStreamTransactionEffectsBuffer::BuildDataChangeRecord(
...
absl::StatusOr<Key>
ChangeStreamTransactionEffectsBuffer::ComputeChangeStreamDataTableKey(
...
void ChangeStreamTransactionEffectsBuffer::Insert(
    zetasql::Value partition_token_str, const ChangeStream* change_stream,
    const InsertOp& op) {
...
void ChangeStreamTransactionEffectsBuffer::Update(
    zetasql::Value partition_token_str, const ChangeStream* change_stream,
    const UpdateOp& op) {
...
void ChangeStreamTransactionEffectsBuffer::Delete(
    zetasql::Value partition_token_str, const ChangeStream* change_stream,
    const DeleteOp& op) {
  std::vector<const Column*> columns;
...
void ChangeStreamTransactionEffectsBuffer::BuildMutation() {
