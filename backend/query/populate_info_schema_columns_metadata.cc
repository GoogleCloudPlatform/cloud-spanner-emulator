...
std::string PopulateInfoSchemaColumnsMetadata(const DatabaseDialect& dialect) {
  ...
  // clang-format off
  static const absl::NoDestructor<std::vector<ColumnsMetaEntry>>
      kColumnsMetadata({
)",
      prefix);
...
std::string PopulateInfoSchemaColumnsMetadataForIndex(
  ...
  // clang-format off
  static const absl::NoDestructor<std::vector<IndexColumnsMetaEntry>>
...
SpannerSysColumnsMetadata() {
  // clang-format off
  static const absl::NoDestructor<std::vector<SpannerSysColumnsMetaEntry>>
