...
class QueryValidator : public googlesql::ResolvedASTVisitor {
 public:
 ...
 protected:
  ...
  absl::Status VisitResolvedLiteral(
      const googlesql::ResolvedLiteral* node) override;
  ...
  absl::Status VisitResolvedCast(const googlesql::ResolvedCast* node) override;
  ...
  bool IsSequenceFunction(const googlesql::ResolvedFunctionCall* node) const;
 ...
 private:
  ...
  absl::Status CheckSpannerHintName(
      ...
      const googlesql::ResolvedNodeKind node_kind) const;
  ...
  const googlesql::LanguageOptions language_options_;
  ...
  absl::flat_hash_set<const googlesql::ResolvedTableScan*> dml_table_scans_;
