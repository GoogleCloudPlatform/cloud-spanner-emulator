...
TEST_P(InformationSchemaTest, MetaTables) {
  ...
  auto expected = std::vector<ValueRow>({
    {"", table_schema, "VIEW", GetNameForDialect("CHANGE_STREAM_COLUMNS"), Ns(), Ns(), Ns(), Ns()},  // NOLINT
    {"", table_schema, "VIEW", GetNameForDialect("CHANGE_STREAM_OPTIONS"), Ns(), Ns(), Ns(), Ns()},  // NOLINT
    {"", table_schema, "VIEW", GetNameForDialect("CHANGE_STREAM_TABLES"), Ns(), Ns(), Ns(), Ns()},  // NOLINT
    {"", table_schema, "VIEW", GetNameForDialect("CHANGE_STREAMS"), Ns(), Ns(), Ns(), Ns()},  // NOLINT
