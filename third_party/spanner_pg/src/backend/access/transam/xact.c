...
{
	// SPANGRES: Spangres does not have any transactions so the start timestamp
	// is always 0. Rather than creating an identical copy of xactStartTimestamp
	// for each thread to make this thread-safe, just return 0 here instead of
	// xactStartTimestamp.
	return 0;
}
