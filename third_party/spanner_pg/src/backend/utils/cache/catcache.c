...
CreateCacheMemoryContext(void)
{
	 ...
	 */
  /* SPANGRES BEGIN */
  // Make this as a child of CurrentMemoryContext instead of Top.
	if (!CacheMemoryContext)
		CacheMemoryContext = AllocSetContextCreate(CurrentMemoryContext,
												   "CacheMemoryContext",
...
SearchCatCacheList(CatCache *cache,
				   ...
				   Datum v3)
{
	Datum		v4 = 0;			/* placeholder last-column value */
	Datum		arguments[CATCACHE_MAXKEYS];
	uint32		lHashValue;
	dlist_iter	iter;
	CatCList   *cl;
