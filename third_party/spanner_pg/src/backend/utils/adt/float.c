...
/* SPANGRES BEGIN */
// Import the new upstream default from PG 12+
// A value >= 1 guarantees round-trip-accurate results.
// A value <= 0 (the default in PG 11) produces a value with as many digits as
// a double can always preserve.  But with some numbers it can preserve more.
int			extra_float_digits = 2; /* Added to DBL_DIG or FLT_DIG */
/* SPANGRES END */
