...
fmgr_info(Oid functionId, FmgrInfo *finfo)
{
	fmgr_info_cxt_security(
		functionId, finfo, CurrentMemoryContext, false);
}
...
// SPANGRES BEGIN
// The functions below allow for SQL NULL results

/*
 * These are for invocation of a previously-looked-up function with a
 * directly-computed parameter list.  Note that arguments are not allowed to be 
 * NULL, but the result is.
 */
Datum
NullableFunctionCall0Coll(FmgrInfo *flinfo, Oid collation)
{
	LOCAL_FCINFO(fcinfo, 0);
	Datum		result;
...
Datum
NullableFunctionCall1Coll(FmgrInfo *flinfo, Oid collation, Datum arg1)
{
	LOCAL_FCINFO(fcinfo, 1);
	Datum		result;
...
Datum
NullableFunctionCall2Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
					Datum arg2)
{
	LOCAL_FCINFO(fcinfo, 2);
	Datum		result;
...
Datum
NullableFunctionCall3Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
...
Datum
NullableFunctionCall4Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
...
Datum
NullableFunctionCall5Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
...
Datum
NullableFunctionCall6Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6)
{
	LOCAL_FCINFO(fcinfo, 6);
	Datum		result;
...
Datum
NullableFunctionCall7Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6,
					Datum arg7)
{
	LOCAL_FCINFO(fcinfo, 7);
...
Datum
NullableFunctionCall8Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6,
...
Datum
NullableFunctionCall9Coll(FmgrInfo *flinfo, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6,
 ...
 * These are for invocation of a function identified by OID with a
 * directly-computed parameter list.  Note that arguments are NOT allowed to be
 * NULL, but the the result is.  These are essentially fmgr_info() followed by
 * NullableFunctionCallN().  If the same function is to be invoked repeatedly,
 * do the fmgr_info() once and then use NullableFunctionCallN().
 */
Datum
NullableOidFunctionCall0Coll(Oid functionId, Oid collation)
{
	FmgrInfo	flinfo;

	fmgr_info(functionId, &flinfo);

	return NullableFunctionCall0Coll(&flinfo, collation);
}

Datum
NullableOidFunctionCall1Coll(Oid functionId, Oid collation, Datum arg1)
{
	FmgrInfo	flinfo;

	fmgr_info(functionId, &flinfo);

	return NullableFunctionCall1Coll(&flinfo, collation, arg1);
}

Datum
NullableOidFunctionCall2Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall2Coll(&flinfo, collation, arg1, arg2);
}

Datum
NullableOidFunctionCall3Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall3Coll(&flinfo, collation, arg1, arg2, arg3);
}

Datum
NullableOidFunctionCall4Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall4Coll(&flinfo, collation, arg1, arg2, arg3, arg4);
}

Datum
NullableOidFunctionCall5Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall5Coll(&flinfo, collation, arg1, arg2, arg3, arg4,
								arg5);
}

Datum
NullableOidFunctionCall6Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall6Coll(&flinfo, collation, arg1, arg2, arg3, arg4,
								arg5, arg6);
}

Datum
NullableOidFunctionCall7Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6,
					Datum arg7)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall7Coll(&flinfo, collation, arg1, arg2, arg3, arg4,
							arg5, arg6, arg7);
}

Datum
NullableOidFunctionCall8Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6,
					Datum arg7, Datum arg8)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall8Coll(&flinfo, collation, arg1, arg2, arg3, arg4,
							arg5, arg6, arg7, arg8);
}

Datum
NullableOidFunctionCall9Coll(Oid functionId, Oid collation, Datum arg1,
					Datum arg2, Datum arg3, Datum arg4, Datum arg5, Datum arg6,
					Datum arg7, Datum arg8, Datum arg9)
{
	FmgrInfo	flinfo;
	...
	return NullableFunctionCall9Coll(&flinfo, collation, arg1, arg2, arg3, arg4,
