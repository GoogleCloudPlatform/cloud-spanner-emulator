 ...
 */
void
AcquireRewriteLocks_UNUSED_SPANGRES(Query *parsetree,
					bool forExecute,
				  ...
				  bool *returning_flag)
{
	...
	if (sub_action->commandType != CMD_UTILITY)
	{
		...
		if (newjointree != NIL)
		{
			 ...
			 * good at all, because the jointree is a placeholder. (Perhaps someday
					...
					int result_rti)
{
	...
	for (attrno = 1; attrno <= numattrs; attrno++)
	{
		...
		/*
		 * For an UPDATE on a trigger-updatable view, provide a placeholder entry
