...
// SPANGRES BEGIN
{
  return raw_parser_spangres(str, mode, NULL);
}

List *
raw_parser_spangres(const char *str, RawParseMode mode, struct SpangresTokenLocations* locations)
// SPANGRES END
{
...
base_yylex(YYSTYPE *lvalp, YYLTYPE *llocp, core_yyscan_t yyscanner)
{
	...
	/* SPANGRES BEGIN */
	add_token_end_start_spangres(*llocp, yyextra->locations);
	yyextra->current_yylloc = *llocp;
	/* SPANGRES END */
