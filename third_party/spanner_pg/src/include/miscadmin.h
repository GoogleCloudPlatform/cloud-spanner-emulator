...
// SPANGRES BEGIN
// When running with ASAN, there is no guarantee that the stack allocations are
// done with uni-directionally addresses, and this breaks the mechanism for
// checking stack overflows in PostgreSQL. Because of this we use a stack
// depth counter which is properly incremented and decremented as functions
// execute.
extern void asan_increment_stack_depth(void);
extern void asan_decrement_stack_depth(void);
// SPANGRES END
