...
typedef struct RestrictInfo
{
	...
	/* see comment above */
	bool		has_clone pg_node_attr(equal_ignore);
	bool		is_clone pg_node_attr(equal_ignore);
	...
	Relids		incompatible_relids pg_node_attr(equal_ignore);
	 ...
	 *----------
	 */
	int			rinfo_serial pg_node_attr(equal_ignore);
