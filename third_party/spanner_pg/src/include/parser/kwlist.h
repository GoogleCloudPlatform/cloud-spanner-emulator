...
/*
 * Make sure any keywords that aren't completly reserved are added to the
 * appropriate list in gram.y. For example, anything tagged UNRESERVED_KEYWORD
 * should be added to the unreserved_keywords list in gram.y.
 */
...
PG_KEYWORD("bit_reversed_positive", BIT_REVERSED_POSITIVE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("columnar", COLUMNAR, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("counter", COUNTER, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("having", HAVING, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("interleave", INTERLEAVE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("length", LENGTH, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("locality", LOCALITY, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("ssd_to_hdd_spill_timespan", SSD_TO_HDD_SPILL_TIMESPAN,
...
PG_KEYWORD("stream", STREAM, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("streams", STREAMS, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("synonym", SYNONYM, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("ttl", TTL, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("vector", VECTOR, UNRESERVED_KEYWORD, BARE_LABEL)
