...
PG_KEYWORD("bit_reversed_positive", BIT_REVERSED_POSITIVE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("counter", COUNTER, UNRESERVED_KEYWORD)
...
PG_KEYWORD("interleave", INTERLEAVE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("parent", PARENT, UNRESERVED_KEYWORD)
...
PG_KEYWORD("streams", STREAMS, UNRESERVED_KEYWORD)
