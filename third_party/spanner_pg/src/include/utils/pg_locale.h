...
extern char *localized_abbrev_days_UNUSED_SPANGRES[];
extern char *localized_full_days_UNUSED_SPANGRES[];
extern char *localized_abbrev_months_UNUSED_SPANGRES[];
extern char *localized_full_months_UNUSED_SPANGRES[];
// SPANGRES END
