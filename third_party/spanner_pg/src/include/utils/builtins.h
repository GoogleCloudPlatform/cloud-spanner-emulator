...
extern void simple_quote_literal(StringInfo buf, const char* val);
...
extern char *format_type_extended_UNUSED_SPANGRES(Oid type_oid, int32 typemod, bits16 flags);
