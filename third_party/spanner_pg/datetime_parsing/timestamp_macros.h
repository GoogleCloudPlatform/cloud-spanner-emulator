 ...
 *
 * datetime_parsing/timestamp_macros.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef DATETIME_PARSING_TIMESTAMP_MACROS_H_
#define DATETIME_PARSING_TIMESTAMP_MACROS_H_

#include "third_party/spanner_pg/datetime_parsing/c.h"

// SPANNER_PG: copied from src/include/datatype/timestamp.h
...
#endif  // DATETIME_PARSING_TIMESTAMP_MACROS_H_
